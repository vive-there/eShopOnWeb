...
public class CheckoutModel : PageModel
{
    ...
    private readonly OrderItemsReserverSender _orderItemsReserverSender;
    ...
    public CheckoutModel(IBasketService basketService,
        ...
        OrderItemsReserverSender orderItemsReserverSender,
        IAppLogger<CheckoutModel> logger)
    {
        ...
        _orderItemsReserverSender = orderItemsReserverSender;
    ...
    public async Task<IActionResult> OnPost(IEnumerable<BasketItemViewModel> items)
    {
        try
        {
            ...
            await _orderItemsReserverSender.SendSalesMessageAsync(invoice);
